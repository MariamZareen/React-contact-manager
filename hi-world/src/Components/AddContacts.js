...
export default class AddContacts extends React.Component{
    ...
    render(){
        return(
            <>
            <div className='ui main' id='addcontacts'>
                <h2>Add Contact</h2>
                <form className='ui form' onSubmit={this.add}>
                    ...
                    <div className='field'>
                        <label>Email</label>
                        <input type='text' name='email' placeholder='Enter your email id'value={this.state.email} onChange={(e)=> this.setState({email:e.target.value})}/>
                    </div>
